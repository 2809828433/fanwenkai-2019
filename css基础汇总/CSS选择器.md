...
1. 后代选择器 div p    选择div后代当中所有的p标签
2. 子元素选择器 div>p 选择div的直系后代p
3. 交集选择器  span.d1  标签名叫span并且class叫做d1
4. 并集选择器  div,p,h1,h2,h3 同时选中当前的这些标签
5. 序列选择器 ul li:first-child ul li:last-child
6. 相邻兄弟选择器 div+p 选择挨着div的p
7. 普通兄弟选择器  div~p 选择div的兄弟元素p 
